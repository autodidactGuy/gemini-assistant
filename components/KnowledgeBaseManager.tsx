  ...
  return (
    <div className="p-4 bg-[#1E1E1E] shadow-md rounded-xl h-full flex flex-col border border-[rgba(255,255,255,0.05)]">
      <div className="flex items-center justify-between mb-3">
        <h2 className="text-xl font-display italic font-black text-white">Experience Sources</h2>
        {onCloseSidebar && (
          <button
      ...
      <p className="text-xs text-[#A8ABB4] mb-4">
        The AI analyzes these URLs to generate answers about Hassan's career.
      </p>
